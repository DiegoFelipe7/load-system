...
public class BusinessException extends ApplicationException {
    ...
    public enum Type {
        ...
        ERROR_INVALID_FORMAT("EL FORMATO DEL ARCHIVO ES INVALIDO SOLO SE PERMITE PDF"),
        ERROR_UPLOAD_NOT_FOUND("EL ARCHIVO NO ESTA REGISTRADO EN LA BD"),
        ERROR_UPLOAD_FILE("OCCURIO UN ERROR AL MOMENTO DE REMPLAZAR EL NUEVO ARCHIVO"),
        ...
        ANNOTATION_NOT_FOUND("EL ANNOTACION NO SE ENCUENTRA REGISTRADA EN EL SISTEMA"),
        a("EL NUMERO DE");
